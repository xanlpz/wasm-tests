...
(module
  ...
  (func $b_i32 (param i32) (result i32) (get_local 0) (i32.const 2) (i32.mul))
  (func $b_i64 (param i64) (result i64) (get_local 0) (i64.const 2) (i64.mul))
  (func $b_f32 (param f32) (result f32) (get_local 0) (f32.const 2) (f32.mul))
  (func $b_f64 (param f64) (result f64) (get_local 0) (f64.const 2) (f64.mul))
)`);
